...
drop table if exists #2017, #2023
/* basic data required */
select distinct qn.questionnaire_name, j.cross_survey_id, j.year, j.jurisdiction_name, j.jurisdiction_type,
...
sq.sub_question_id, sq.sub_question, 
...
where q.year in (2017)  --and q.question_num = 8 and j.jurisdiction_id = 1001
...
/* was a table intended to show responses to each question, but we can functionally just query response = "NA" instead. rather not do manual work: */
--left join dbo.responses r on q.question_id = r.question_id and qn.questionnaire_id = r.questionnaire_id and q.year = r.year
where q.year in (2023)  --and q.question_num = 8 and j.jurisdiction_id = 1001
order by j.jurisdiction_name, q.question_num asc, sub_question_id asc, category_id asc


select a.questionnaire_name, a.year, a.jurisdiction_name, a.matched_question,
a.question_num, a.question_desc, b.question_num, b.question_desc,
a.sub_question_id, a.sub_question, b.sub_question_id, b.sub_question,
a.category_id, a.category_desc, b.category_id, b.category_desc,
