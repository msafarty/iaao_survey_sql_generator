...
/* basic data required */
select distinct qn.questionnaire_name, j.jurisdiction_name, j.jurisdiction_type, q.question_num, q.question_desc, sq.sub_question_id, sq.sub_question, rc.category_id, rc.category_desc, rd.response
from 
dbo.responses_detail rd --detailed responses
join dbo.jurisdictions j on rd.jurisdiction_id = j.jurisdiction_id --jurisdictional info
